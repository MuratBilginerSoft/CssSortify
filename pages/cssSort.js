...
const { sortByLengthDesc, sortByLengthAsc } = require('./sortByLength');
const { sortAlphabetically, sortAlphabeticallyDesc } = require('./sortAlphabetically');
const { sortByCategory } = require('./sortByCategory');
const { sortPropertiesWithSpacing } = require('./sortWithSpacing');
const { formatPropertyValue, parseProperties } = require('./cssUtils');
...
function sortProperties(properties, sortType, isNested = false) {
    ...
    switch (sortType) {
        ...
        case 'category-with-spacing':
            return sortPropertiesWithSpacing(properties, isNested);
        default:
            return properties;
    }
}
